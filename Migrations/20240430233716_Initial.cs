        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePhoto = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_mapOfEvents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TableEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TableEvents_mapOfEvents_MapId",
                        column: x => x.MapId,
                        principalTable: "mapOfEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_TableEvents_EventId",
                        column: x => x.EventId,
                        principalTable: "TableEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
